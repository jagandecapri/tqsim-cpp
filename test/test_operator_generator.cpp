 ...
 * @return true if both real and imaginary parts are within the tolerance, false
 * otherwise.
 */
bool complexIsApprox(const std::complex<double>& a,
                     const std::complex<double>& b, double tol = 1e-6) {
...
TEST(FFunctionTest, TestCases) {
  ...
  Eigen::Matrix<double, 2, 2> result_case1 =
      operator_generator.F(a1_case1, a2_case1, a3_case1, outcome_case1);
  Eigen::Matrix<double, 2, 2> expected_case1;
  const double inv_phi = (std::sqrt(5) - 1) / 2;
  expected_case1 << inv_phi, std::sqrt(inv_phi), std::sqrt(inv_phi), -inv_phi;
  ...
  Eigen::Matrix<double, 2, 2> result_case2 =
      operator_generator.F(a1_case2, a2_case2, a3_case2, outcome_case2);
  Eigen::Matrix<double, 2, 2> expected_case2;
  expected_case2 << 0, 0, 0, 1;
...
TEST(RFunctionTest, TestCases) {
  ...
  Eigen::Matrix<std::complex<double>, 2, 2> result_case1 =
      operator_generator.R(a1_case1, a2_case1);
  Eigen::Matrix<std::complex<double>, 2, 2> expected_case1;
  const double pi = std::acos(-1);
  std::complex<double> exp_val1 =
      std::exp(std::complex<double>(0.0, -4 * pi / 5.0));
  std::complex<double> exp_val2 =
      std::exp(std::complex<double>(0.0, 3 * pi / 5.0));
  ...
  Eigen::Matrix<std::complex<double>, 2, 2> result_case2 =
      operator_generator.R(a1_case2, a2_case2);
...
TEST(BFunctionTest, TestCases) {
  ...
  Eigen::Matrix<std::complex<double>, 2, 2> result_case1 =
      operator_generator.B(a0, a1, a2, outcome);
  Eigen::Matrix<std::complex<double>, 2, 2> expected_case1;
  expected_case1 << std::complex<double>(-0.5, 0.36327126400268051),
      std::complex<double>(-0.24293413587832285, -0.74767439061061047),
      std::complex<double>(-0.24293413587832285, -0.74767439061061047),
      std::complex<double>(-0.61803398874989468, 5.5511151231257827E-17);
  ASSERT_TRUE(complexIsApprox(result_case1(0, 0), expected_case1(0, 0)) &&
              complexIsApprox(result_case1(0, 1), expected_case1(0, 1)) &&
              complexIsApprox(result_case1(1, 0), expected_case1(1, 0)) &&
              complexIsApprox(result_case1(1, 1), expected_case1(1, 1)));
...
TEST(SigmaFunctionTest, TestCases) {
  ...
  std::complex<double> result_case1 =
      operator_generator.sigma(index_case1, state_f_case1, state_i_case1);

  // You need to define the expected result for the test case based on your
...
TEST(LFunctionTest, TestCases) {
  ...
  std::complex<double> result_case1 = operator_generator.L(
      k_case1, h_case1, i_case1, icase1, jj_case1, jj_case1);
...
TEST(SFunctionTest, TestCases) {
  ...
  std::complex<double> result_case1 =
      operator_generator.S(jm_case1, jmo_case1, jmoo_case1, jmocase1, h_case1,
...
TEST(GenSigmaFunctionTest, TestCases) {
  ...
  State state_i_case_1 = {.qudits = {{0, 1}, {0, 1}}, .roots = {0}};
...
TEST(GenerateBraidingOperator, TestCases) {
  ...
  expected_case1 << std::complex<double>(-0.8090169943749473,
                                         -0.5877852522924732),
